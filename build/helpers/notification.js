...
function notification(options, callback) {
  if (typeof options === 'string') {
    ...
    throw new TypeError("Notification expects at least a 'message' parameter");
  }

  if (typeof options.icon === 'undefined') {
    options.icon =
      'https://user-images.githubusercontent.com/4596862/54868065-c2aea200-4d5e-11e9-9ce3-e0013c15f48c.png';
  }
