 ...
 */
export const developmentConcatFilesArgs = [developmentGlobOptions, developmentConcatOptions];
export const productionConcatFilesArgs = [productionGlobOptions, productionConcatOptions];
...
export default async function concatFiles(globOptions = null, concatOptions = null) {
   ...
   * @return {Promise}
   */
  loconfig.tasks.concats?.forEach(async ({ includes, outfile, label = null }) => {
    if (!label) {
